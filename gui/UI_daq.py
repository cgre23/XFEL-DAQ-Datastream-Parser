...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.stopdate.setMaximumSize(QtCore.QSize(500, 16777215))
        ...
        self.gridLayout.addWidget(self.browsepb, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.channelpb, 1, 4, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.groupBox)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout.addWidget(self.pushButton, 1, 5, 1, 1)
        self.localmoderb = QtWidgets.QRadioButton(self.groupBox)
        self.localmoderb.setObjectName("localmoderb")
        self.gridLayout.addWidget(self.localmoderb, 2, 0, 1, 1)
        self.rawFileSelectpb = QtWidgets.QPushButton(self.groupBox)
        self.rawFileSelectpb.setObjectName("rawFileSelectpb")
        self.gridLayout.addWidget(self.rawFileSelectpb, 2, 1, 1, 1)
        self.filesSelected = QtWidgets.QLabel(self.groupBox)
        self.filesSelected.setText("")
        self.filesSelected.setObjectName("filesSelected")
        self.gridLayout.addWidget(self.filesSelected, 2, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.localmoderb.setText(_translate("Form", "Local Mode (supply raw files)"))
        self.rawFileSelectpb.setText(_translate("Form", "Select raw file(s) from folder"))
